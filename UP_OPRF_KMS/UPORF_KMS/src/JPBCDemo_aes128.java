...
public class JPBCDemo_aes128 {
    public static void main(String[] args) {
        ...
        // Hash the element z into a 128-bit value using SHA-1
        byte[] zBytes = z.toBytes();
        byte[] hashedValue = hashTo128Bits(zBytes);
        System.out.println("Hashed value of z (in hexadecimal): " + bytesToHex(hashedValue));
    }

    // Hashing function to SHA-1
    public static byte[] hashTo128Bits(byte[] input) {
        try {
